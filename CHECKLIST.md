...
| V-EXT-INLINE-b | Sidebar on Claude.ai | ✅ | `BLOCKS/V-EXT-INLINE-bcde-multi-host.md` | `pending` |
| V-EXT-INLINE-c | Sidebar on Gemini | ✅ | `BLOCKS/V-EXT-INLINE-bcde-multi-host.md` | `pending` |
| V-EXT-INLINE-d | Sidebar on Rufus/Amazon | ✅ | `BLOCKS/V-EXT-INLINE-bcde-multi-host.md` | `pending` |
| V-EXT-INLINE-e | Sidebar on Perplexity | ✅ | `BLOCKS/V-EXT-INLINE-bcde-multi-host.md` | `pending` |
